      ...
      {isLoadingFoods
        ...
        : (
          <div className='container__food'>
            ...
            <button className='container__food--button' onClick={() => handleFoodClick('Lunch')}>
              <label className='container__food--label' htmlFor=''>
                Lunch
              </label>
              <img
            ...
            <button className='container__food--button' onClick={() => handleFoodClick('Dinner')}>
              <label className='container__food--label' htmlFor=''>
                Dinner
              </label>
              <img
            ...
            <button className='container__food--button' onClick={() => handleFoodClick('Vegan')}>
              <label className='container__food--label' htmlFor=''>
                Vegan
              </label>
              <img
